...
CREATE TABLE `stored_in` (
  `Bb_id` int NOT NULL,
  `Bds_id` int NOT NULL,
  PRIMARY KEY (`Bb_id`,`Bds_id`),
  KEY `Bds_id` (`Bds_id`),
  CONSTRAINT `stored_in_ibfk_1` FOREIGN KEY (`Bb_id`) REFERENCES `blood_bank` (`Bb_id`),
  CONSTRAINT `stored_in_ibfk_2` FOREIGN KEY (`Bds_id`) REFERENCES `blood_samples` (`Bds_id`)
...
INSERT INTO `stored_in` VALUES (211290001,211260001),(211290001,211260002),(211290001,211260003);
